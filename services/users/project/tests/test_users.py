...
class TestUserService(BaseTestCase):
    ...
    def test_add_user_invalid_json_keys(self):
        """  Ensure error is throw if the JSON object does
    ...
    def test_single_user_no_id(self):
        """Ensure error is thrown if an id is not provides."""
        with self.client:
    ...
    def test_main_no_users(self):
        """Ensure the main route behaves correclty when no users have been
